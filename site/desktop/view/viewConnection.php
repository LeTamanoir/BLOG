      ...
      <div class="login-connexion">
        <form id=container_connexion action="" method="post">
          ...
          <div class=password_container>
            ...
            <button id="unmask" class="unmask" type="button" title="Mask/Unmask" onclick="switch_eye(1);seePass(1)"><img id=image_eye_1 src="/icons/login/100px/eye.png" alt="voir mdp"></button>
          </div>
